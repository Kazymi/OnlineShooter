...
namespace Com.Kawaiisun.SimpleHostile
{
    public class Player : MonoBehaviourPunCallbacks, IPunObservable
    {
        ...
        private void Update()
        {
            ...
            //States
            bool isGrounded = Physics.Raycast(groundDetector.position, Vector3.down, 0.15f);
        ...
        void FixedUpdate()
        {
            ...
            //States
            isGrounded = Physics.Raycast(groundDetector.position, Vector3.down, 0.1f);
            bool isJumping = jump && isGrounded;
            bool isSprinting = sprint && t_vmove > 0 && !weapon.MinigunItAit;
